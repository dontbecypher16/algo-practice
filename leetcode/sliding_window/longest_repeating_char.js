...
console.log(characterReplacement(testString))

/**
 * Input: string and k for times one can change characters
 * Output: integer value of substring with most repeating characters
 * Edge cases
