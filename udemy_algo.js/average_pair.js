 ...
 * 
 * If array of numbers length is 0 go ahead and return false
 * Declare two pointers
 * if j pointer and i pointer adds and divide value equals to target
 * return true
 * if not decrease j pointer and repeat process above 
 * 
 */
